...
public class HelpItemForHelpActivityFactory implements HelpItemFactory {
    ...
    public HashMap<Integer, HelpItem> getHelpItems() {
        ...
        helpItems.put(0, new HelpItem("Wie funktioniert der Crypto Tracker?", "Du musst im Eingabefeld dein gewünschten Bitcoin Preis eingeben und der Tracker gibt dir sofort eine Warnung aus, wenn diese Position erreicht wurde. Der Tracker läuft im Hintergrund weiter."));
